...
public class FES_1FM_Page extends FES_NKO_Page {

	public FES_1FM_Page(PageManager pages) {
		super(pages);		
	}
	
	public FES_1FM_Page ensurePageLoaded() {
	...
	public FES_1FM_Page selectInfoAboutOperationTab() {
		clickElement(infoAboutOperationTabLink);
		return this;
	}
	
	public FES_1FM_Page addRecord() {
		clickElement(addRecordButton);
		return this;
	}
	
	public FES_1FM_Page addReason() {
		clickElement(addReasonButton);
		return this;
	}
	
	public FES_1FM_Page addInfoAboutParticipant() throws InterruptedException {
		Thread.sleep(2000);
		clickElement(addInfoAboutParticipantButton);
		return this;
	}
	
	public FES_1FM_Page selectFirstRecord() {
	...
	public FES_1FM_Page clickOK() {
		clickElement(okButton);
		return this;
	}
	
	public FES_1FM_Page setID(String value) {
		setValue(id, value);
		return this;
	}
	
	public FES_1FM_Page selectRecordTypeFES(String value) {
		selectOption(recordTypeFES, value);
		return this;
	}
	
	public FES_1FM_Page setDateOfChange(String value) {
	...
	public FES_1FM_Page selectSignFinancingOfTerrorizm(String value) {
		selectOptionFromLongList(signFinancingOfTerrorizm, value);
		return this;
	}
	
	public FES_1FM_Page setDateOperation(String value) {
		setValue(dateOperation, value);
		return this;
	}
	
	public FES_1FM_Page setDateDetectOperation(String value) {
		setValue(dateDetectOperation, value);
		return this;
	}
	
	public FES_1FM_Page selectOperationTypeCode(String value) {
		selectOptionFromLongList(operationTypeCode, value);
		return this;
	}
	
	public FES_1FM_Page selectOperationTypeAddCode(String value) {
		selectOptionFromLongList(operationTypeAddCode, value);
		return this;
	}
	
	public FES_1FM_Page selectCodeOfUnusualOperation(String value) {
		selectOptionFromLongList(codeOfUnusualOperation, value);
		return this;
	}
	
	public FES_1FM_Page selectCurrencyCode(String value) {
		selectOptionFromLongList(currencyCode, value);
		return this;
	}
	
	public FES_1FM_Page setSum(String value) {
		setValue(sum, value);
		return this;
	}
	
	public FES_1FM_Page setSumRUR(String value) {
		setValue(sumRUR, value);
		return this;
	}
	
	public FES_1FM_Page selectCodePreciousMetals(String value) {
		selectOptionFromLongList(codePreciousMetals, value);
		return this;
	}
	
	public FES_1FM_Page setPurposePay(String value) {
		setValue(purposePay, value);
		return this;
	}
	
	public FES_1FM_Page selectSignOperationCode(String value) {
		selectOptionFromLongList(signOperationCode, value);
		return this;
	}
	
	public FES_1FM_Page selectCodeTypeMoney(String value) {
	...
	public FES_1FM_Page setCharOperation(String value) {
		setValue(charOperation, value);
		return this;
	}
	
	public FES_1FM_Page setAdditionalInfo(String value) {
		setValue(additionalInfo, value);
		return this;
	}
	
	public FES_1FM_Page selectCodeTypeDoc(String value) {
		selectOptionFromLongList(codeTypeDoc, value);
		return this;
	}
	
	public FES_1FM_Page setDateDoc(String value) {
		setValue(dateDoc, value);
		return this;
	}
	
	public FES_1FM_Page setNumberDoc(String value) {
		setValue(numberDoc, value);
		return this;
	}
	
	public FES_1FM_Page setSummaryDoc(String value) {
		setValue(summaryDoc, value);
		return this;
	}
	
	public FES_1FM_Page selectRoleOfParticipantCode(String value) {
		selectOptionFromLongList(roleOfParticipantCode, value);
		return this;
	}
	
	public FES_1FM_Page selectTypeOfParticipantCode(String value) {
		selectOptionFromLongList(typeOfParticipantCode, value);
		return this;
	}
	
	public FES_1FM_Page selectSignOfCommunionToTerrorism(String value) {
		selectOption(signOfCommunionToTerrorism, value);
		return this;
	}
	
	public FES_1FM_Page selectBaseApplyingMeasuresCode(String value) {
	...
	public FES_1FM_Page setCodeULFL(String value) {
		if (!signOfCommunionToTerrorism.getText().contains("0")) {
	...
	public FES_1FM_Page selectTypeOfParticipant(String value) {
		selectOption(typeOfParticipant, value);
		return this;
	}
	
	public FES_1FM_Page setResidentSign(String value) {
		if (value.equals("1")) {
	...
	public FES_1FM_Page setClientSign(String value) {
		if (value.equals("1")) {
	...
	public FES_1FM_Page setNameLP(String value) {
	...
	public FES_1FM_Page selectTypeCodeLP(String value) {
		if (typeOfParticipant.getText().contains("для юридического лица")) {
	...
	public FES_1FM_Page setINNLP(String value) {
		if (typeOfParticipant.getText().contains("для юридического лица")) {
	...
	public FES_1FM_Page setKPPLP(String value) {
		if (typeOfParticipant.getText().contains("для юридического лица")) {
	...
	public FES_1FM_Page setOKPOLP(String value) {
		if (typeOfParticipant.getText().contains("для юридического лица")) {
	...
	public FES_1FM_Page selectOKVEDLP(String value) {
		if (typeOfParticipant.getText().contains("для юридического лица")) {
			try {
	...
	public FES_1FM_Page selectIndustryCodeLP(String value) {
		if (typeOfParticipant.getText().contains("для юридического лица")) {
			try {
	...
	public FES_1FM_Page setOGRNLP(String value) {
		if (typeOfParticipant.getText().contains("для юридического лица")) {
	...
	public FES_1FM_Page setRegOrgNameLP(String value) {
		if (typeOfParticipant.getText().contains("для юридического лица")) {
	...
	public FES_1FM_Page setRegDateLP(String value) {
		if (typeOfParticipant.getText().contains("для юридического лица")) {
	...
	public FES_1FM_Page selectUrAddressCountryCodeLP(String value) {
		if (typeOfParticipant.getText().contains("для юридического лица")) {
	...
	public FES_1FM_Page selectUrAddressSubjectCodeLP(String value) {
		if (typeOfParticipant.getText().contains("для юридического лица")) {
	...
	public FES_1FM_Page setUrAddressAreaLP(String value) {
		if (typeOfParticipant.getText().contains("для юридического лица")) {
	...
	public FES_1FM_Page setUrAddressCityLP(String value) {
		if (typeOfParticipant.getText().contains("для юридического лица")) {
	...
	public FES_1FM_Page setUrAddressStreetLP(String value) {
		if (typeOfParticipant.getText().contains("для юридического лица")) {
	...
	public FES_1FM_Page setUrAddressHouseLP(String value) {
		if (typeOfParticipant.getText().contains("для юридического лица")) {
	...
	public FES_1FM_Page setUrAddressCorpLP(String value) {
		if (typeOfParticipant.getText().contains("для юридического лица")) {
	...
	public FES_1FM_Page setUrAddressApartmentLP(String value) {
		if (typeOfParticipant.getText().contains("для юридического лица")) {
	...
	public FES_1FM_Page selectRegAddressCountryCodeLP(String value) {
		if (typeOfParticipant.getText().contains("для юридического лица")) {
	...
	public FES_1FM_Page selectRegAddressSubjectCodeLP(String value) {
		if (typeOfParticipant.getText().contains("для юридического лица")) {
	...
	public FES_1FM_Page setRegAddressAreaLP(String value) {
		if (typeOfParticipant.getText().contains("для юридического лица")) {
	...
	public FES_1FM_Page setRegAddressCityLP(String value) {
		if (typeOfParticipant.getText().contains("для юридического лица")) {
	...
	public FES_1FM_Page setRegAddressStreetLP(String value) {
		if (typeOfParticipant.getText().contains("для юридического лица")) {
	...
	public FES_1FM_Page setRegAddressHouseLP(String value) {
		if (typeOfParticipant.getText().contains("для юридического лица")) {
	...
	public FES_1FM_Page setRegAddressCorpLP(String value) {
		if (typeOfParticipant.getText().contains("для юридического лица")) {
	...
	public FES_1FM_Page setRegAddressApartmentLP(String value) {
		if (typeOfParticipant.getText().contains("для юридического лица")) {
	...
	public FES_1FM_Page setRegAddressIPLP(String value) {
		if (typeOfParticipant.getText().contains("для юридического лица")) {
	...
	public FES_1FM_Page selectCodePP(String value) {
		if (!typeOfParticipant.getText().contains("для юридического лица")) {
	...
	public FES_1FM_Page setSurnamePP(String value) {
		if (!typeOfParticipant.getText().contains("для юридического лица")) {
	...
	public FES_1FM_Page setNamePP(String value) {
		if (!typeOfParticipant.getText().contains("для юридического лица")) {
	...
	public FES_1FM_Page setPatronymicPP(String value) {
		if (!typeOfParticipant.getText().contains("для юридического лица")) {
	...
	public FES_1FM_Page setINNPP(String value) {
		if (!typeOfParticipant.getText().contains("для юридического лица")) {
	...
	public FES_1FM_Page selectIndustryCodePP(String value) {
		if (!typeOfParticipant.getText().contains("для юридического лица")) {
	...
	public FES_1FM_Page selectOKVEDPP(String value) {
	...
	public FES_1FM_Page setOGRNPP(String value) {
		if (typeOfParticipant.getText().contains("для индивидуального предпринимателя")) {
	...
	public FES_1FM_Page setRegOrgNamePP(String value) {
		if (typeOfParticipant.getText().contains("для индивидуального предпринимателя")) {
	...
	public FES_1FM_Page setRegDatePP(String value) {
		if (typeOfParticipant.getText().contains("для индивидуального предпринимателя")) {
	...
	public FES_1FM_Page selectIdentityDocTypePP(String value) {
		if (!typeOfParticipant.getText().contains("для юридического лица")) {
	...
	public FES_1FM_Page setIdentityDocSeriePP(String value) {
		if (!typeOfParticipant.getText().contains("для юридического лица")) {
	...
	public FES_1FM_Page setIdentityDocNumberPP(String value) {
		if (!typeOfParticipant.getText().contains("для юридического лица")) {
	...
	public FES_1FM_Page setIdentityDocIssueDatePP(String value) {
		if (!typeOfParticipant.getText().contains("для юридического лица")) {
	...
	public FES_1FM_Page setIdentityDocIssuerPP(String value) {
		if (!typeOfParticipant.getText().contains("для юридического лица")) {
	...
	public FES_1FM_Page setIdentityDocCodeSubDivisionPP(String value) {
		if (!typeOfParticipant.getText().contains("для юридического лица")) {
	...
	public FES_1FM_Page setBirthDatePP(String value) {
		if (!typeOfParticipant.getText().contains("для юридического лица")) {
	...
	public FES_1FM_Page selectBirthPlaceCountryCodePP(String value) {
		if (!typeOfParticipant.getText().contains("для юридического лица")) {
	...
	public FES_1FM_Page selectBirthPlaceSubjectCodePP(String value) {
		if (!typeOfParticipant.getText().contains("для юридического лица")) {
	...
	public FES_1FM_Page setBirthPlaceAreaPP(String value) {
		if (!typeOfParticipant.getText().contains("для юридического лица")) {
	...
	public FES_1FM_Page setBirthPlaceCityPP(String value) {
		if (!typeOfParticipant.getText().contains("для юридического лица")) {
	...
	public FES_1FM_Page selectBirthPlaceCitizenshipCodePP(String value) {
		if (!typeOfParticipant.getText().contains("для юридического лица")) {
	...
	public FES_1FM_Page selectPublicFacesSignPP(String value) {
		if (!typeOfParticipant.getText().contains("для юридического лица")) {
	...
	public FES_1FM_Page selectRegAddressCountryCodePP(String value) {
		if (!typeOfParticipant.getText().contains("для юридического лица")) {
	...
	public FES_1FM_Page selectRegAddressSubjectCodePP(String value) {
		if (!typeOfParticipant.getText().contains("для юридического лица")) {
	...
	public FES_1FM_Page setRegAddressAreaPP(String value) {
		if (!typeOfParticipant.getText().contains("для юридического лица")) {
	...
	public FES_1FM_Page setRegAddressCityPP(String value) {
		if (!typeOfParticipant.getText().contains("для юридического лица")) {
	...
	public FES_1FM_Page setRegAddressStreetPP(String value) {
		if (!typeOfParticipant.getText().contains("для юридического лица")) {
	...
	public FES_1FM_Page setRegAddressHousePP(String value) {
		if (!typeOfParticipant.getText().contains("для юридического лица")) {
	...
	public FES_1FM_Page setRegAddressCorpPP(String value) {
		if (!typeOfParticipant.getText().contains("для юридического лица")) {
	...
	public FES_1FM_Page setRegAddressApartmentPP(String value) {
		if (!typeOfParticipant.getText().contains("для юридического лица")) {
	...
	public FES_1FM_Page setRegAddressIPPP(String value) {
		if (!typeOfParticipant.getText().contains("для юридического лица")) {
	...
	public FES_1FM_Page selectActualAddressCountryCodePP(String value) {
		if (!typeOfParticipant.getText().contains("для юридического лица")) {
	...
	public FES_1FM_Page selectActualAddressSubjectCodePP(String value) {
		if (!typeOfParticipant.getText().contains("для юридического лица")) {
	...
	public FES_1FM_Page setActualAddressAreaPP(String value) {
		if (!typeOfParticipant.getText().contains("для юридического лица")) {
	...
	public FES_1FM_Page setActualAddressCityPP(String value) {
		if (!typeOfParticipant.getText().contains("для юридического лица")) {
	...
	public FES_1FM_Page setActualAddressStreetPP(String value) {
		if (!typeOfParticipant.getText().contains("для юридического лица")) {
	...
	public FES_1FM_Page setActualAddressHousePP(String value) {
		if (!typeOfParticipant.getText().contains("для юридического лица")) {
	...
	public FES_1FM_Page setActualAddressCorpPP(String value) {
		if (!typeOfParticipant.getText().contains("для юридического лица")) {
	...
	public FES_1FM_Page setActualAddressApartmentPP(String value) {
		if (!typeOfParticipant.getText().contains("для юридического лица")) {
	...
	public FES_1FM_Page setActualAddressIPPP(String value) {
		if (!typeOfParticipant.getText().contains("для юридического лица")) {
	...
	public FES_1FM_Page setBIK(String value) {
		setValue(bik, value);
		return this;
	}
	
	public FES_1FM_Page setBankAccountNumber(String value) {
		setValue(bankAccountNumber, value);
		return this;
	}
	
	public FES_1FM_Page setBankName(String value) {
	...
	public void inputAllValues1FM(FES_1FM_DOC fes) throws InterruptedException {		
		...
		pages.fes_1fm_Page.ensurePageLoaded()
