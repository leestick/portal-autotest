package comita.auto.selenium.webdriver;
...
public class WebDriverFactory {
	...
	public static WebDriver getInstance(String gridHubUrl, Browser browser,
		...
		if (CHROME.equals(browserName)) {
			...
			capability.setCapability(CapabilityType.UNEXPECTED_ALERT_BEHAVIOUR, org.openqa.selenium.UnexpectedAlertBehaviour.ACCEPT);
