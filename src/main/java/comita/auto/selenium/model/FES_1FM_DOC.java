...
public class FES_1FM_DOC extends FES_DOC {
	...
	public FES_1FM_DOC writeData() {
        Properties property = new Properties();
 
        try {
        	String path = "src/test/resources/test_data/FES_1FM.txt";
	...
	public FES_1FM_DOC setId(String id) {
		this.id = id;
		return this;
	}
	...
	public FES_1FM_DOC setRecordTypeFES(String recordTypeFES) {
	...
	public FES_1FM_DOC setDateOfChange(String dateOfChange) {
	...
	public FES_1FM_DOC setSignFinancingOfTerrorizm(String signFinancingOfTerrorizm) {
	...
	public FES_1FM_DOC setDateOperation(String dateOperation) {
	...
	public FES_1FM_DOC setDateDetectOperation(String dateDetectOperation) {
	...
	public FES_1FM_DOC setOperationTypeCode(String operationTypeCode) {
	...
	public FES_1FM_DOC setOperationTypeAddCode(String operationTypeAddCode) {
	...
	public FES_1FM_DOC setCodeOfUnusualOperation(String codeOfUnusualOperation) {
	...
	public FES_1FM_DOC setCurrencyCode(String currencyCode) {
	...
	public FES_1FM_DOC setSum(String sum) {
		this.sum = sum;
		return this;
	}
	...
	public FES_1FM_DOC setSumRUR(String sumRUR) {
		this.sumRUR = sumRUR;
		return this;
	}
	...
	public FES_1FM_DOC setCodePreciousMetals(String codePreciousMetals) {
	...
	public FES_1FM_DOC setPurposePay(String purposePay) {
	...
	public FES_1FM_DOC setSignOperationCode(String signOperationCode) {
	...
	public FES_1FM_DOC setCodeTypeMoney(String codeTypeMoney) {
	...
	public FES_1FM_DOC setCharOperation(String charOperation) {
	...
	public FES_1FM_DOC setAdditionalInfo(String additionalInfo) {
	...
	public FES_1FM_DOC setCodeTypeDoc(String codeTypeDoc) {
	...
	public FES_1FM_DOC setDateDoc(String dateDoc) {
	...
	public FES_1FM_DOC setNumberDoc(String numberDoc) {
	...
	public FES_1FM_DOC setSummaryDoc(String summaryDoc) {
	...
	public FES_1FM_DOC setRoleOfParticipantCode(String roleOfParticipantCode) {
	...
	public FES_1FM_DOC setRoleOfParticipant2Code(String roleOfParticipant2Code) {
	...
	public FES_1FM_DOC setTypeOfParticipantCode(String typeOfParticipantCode) {
	...
	public FES_1FM_DOC setSignOfCommunionToTerrorism(String signOfCommunionToTerrorism) {
	...
	public FES_1FM_DOC setBaseApplyingMeasuresCode(String baseApplyingMeasuresCode) {
	...
	public FES_1FM_DOC setCodeULFL(String codeULFL) {
	...
	public FES_1FM_DOC setTypeOfParticipant(String typeOfParticipant) {
	...
	public FES_1FM_DOC setResidentSign(String residentSign) {
	...
	public FES_1FM_DOC setClientSign(String clientSign) {
	...
	public FES_1FM_DOC setNameLP(String nameLP) {
		this.nameLP = nameLP;
		return this;
	}
	...
	public FES_1FM_DOC setTypeCodeLP(String typeCodeLP) {
	...
	public FES_1FM_DOC setInnLP(String innLP) {
		this.innLP = innLP;
		return this;
	}
	...
	public FES_1FM_DOC setKppLP(String kppLP) {
		this.kppLP = kppLP;
		return this;
	}
	...
	public FES_1FM_DOC setOkpoLP(String okpoLP) {
		this.okpoLP = okpoLP;
		return this;
	}
	...
	public FES_1FM_DOC setIndustryCodeLP(String industryCodeLP) {
	...
	public FES_1FM_DOC setOkvedLP(String okvedLP) {
	...
	public FES_1FM_DOC setOgrnLP(String ogrnLP) {
		this.ogrnLP = ogrnLP;
		return this;
	}
	...
	public FES_1FM_DOC setRegOrgNameLP(String regOrgNameLP) {
	...
	public FES_1FM_DOC setRegDateLP(String regDateLP) {
	...
	public FES_1FM_DOC setUrAddressCountryCodeLP(String urAddressCountryCodeLP) {
	...
	public FES_1FM_DOC setUrAddressSubjectCodeLP(String urAddressSubjectCodeLP) {
	...
	public FES_1FM_DOC setUrAddressAreaLP(String urAddressAreaLP) {
	...
	public FES_1FM_DOC setUrAddressCityLP(String urAddressCityLP) {
	...
	public FES_1FM_DOC setUrAddressStreetLP(String urAddressStreetLP) {
	...
	public FES_1FM_DOC setUrAddressHouseLP(String urAddressHouseLP) {
	...
	public FES_1FM_DOC setUrAddressCorpLP(String urAddressCorpLP) {
	...
	public FES_1FM_DOC setUrAddressApartmentLP(String urAddressApartmentLP) {
	...
	public FES_1FM_DOC setRegAddressCountryCodeLP(String regAddressCountryCodeLP) {
	...
	public FES_1FM_DOC setRegAddressSubjectCodeLP(String regAddressSubjectCodeLP) {
	...
	public FES_1FM_DOC setRegAddressAreaLP(String regAddressAreaLP) {
	...
	public FES_1FM_DOC setRegAddressCityLP(String regAddressCityLP) {
	...
	public FES_1FM_DOC setRegAddressStreetLP(String regAddressStreetLP) {
	...
	public FES_1FM_DOC setRegAddressHouseLP(String regAddressHouseLP) {
	...
	public FES_1FM_DOC setRegAddressCorpLP(String regAddressCorpLP) {
	...
	public FES_1FM_DOC setRegAddressApartmentLP(String regAddressApartmentLP) {
	...
	public FES_1FM_DOC setRegAddressIPLP(String regAddressIPLP) {
	...
	public FES_1FM_DOC setCodePP(String codePP) {
		this.codePP = codePP;
		return this;
	}
	...
	public FES_1FM_DOC setSurnamePP(String surnamePP) {
	...
	public FES_1FM_DOC setNamePP(String namePP) {
		this.namePP = namePP;
		return this;
	}
	...
	public FES_1FM_DOC setPatronymicPP(String patronymicPP) {
	...
	public FES_1FM_DOC setInnPP(String innPP) {
		this.innPP = innPP;
		return this;
	}
	...
	public FES_1FM_DOC setIndustryCodePP(String industryCodePP) {
	...
	public FES_1FM_DOC setIdentityDocTypePP(String identityDocTypePP) {
	...
	public FES_1FM_DOC setIdentityDocSeriePP(String identityDocSeriePP) {
	...
	public FES_1FM_DOC setIdentityDocNumberPP(String identityDocNumberPP) {
	...
	public FES_1FM_DOC setIdentityDocIssueDatePP(String identityDocIssueDatePP) {
	...
	public FES_1FM_DOC setIdentityDocIssuerPP(String identityDocIssuerPP) {
	...
	public FES_1FM_DOC setIdentityDocCodeSubDivisionPP(String identityDocCodeSubDivisionPP) {
	...
	public FES_1FM_DOC setBirthDatePP(String birthDatePP) {
	...
	public FES_1FM_DOC setBirthPlaceCountryCodePP(String birthPlaceCountryCodePP) {
	...
	public FES_1FM_DOC setBirthPlaceSubjectCodePP(String birthPlaceSubjectCodePP) {
	...
	public FES_1FM_DOC setBirthPlaceAreaPP(String birthPlaceAreaPP) {
	...
	public FES_1FM_DOC setBirthPlaceCityPP(String birthPlaceCityPP) {
	...
	public FES_1FM_DOC setBirthPlaceCitizenshipCodePP(String birthPlaceCitizenshipCodePP) {
	...
	public FES_1FM_DOC setPublicFacesSignPP(String publicFacesSignPP) {
	...
	public FES_1FM_DOC setRegAddressCountryCodePP(String regAddressCountryCodePP) {
	...
	public FES_1FM_DOC setRegAddressSubjectCodePP(String regAddressSubjectCodePP) {
	...
	public FES_1FM_DOC setRegAddressAreaPP(String regAddressAreaPP) {
	...
	public FES_1FM_DOC setRegAddressCityPP(String regAddressCityPP) {
	...
	public FES_1FM_DOC setRegAddressStreetPP(String regAddressStreetPP) {
	...
	public FES_1FM_DOC setRegAddressHousePP(String regAddressHousePP) {
	...
	public FES_1FM_DOC setRegAddressCorpPP(String regAddressCorpPP) {
	...
	public FES_1FM_DOC setRegAddressApartmentPP(String regAddressApartmentPP) {
	...
	public FES_1FM_DOC setRegAddressIPPP(String regAddressIPPP) {
	...
	public FES_1FM_DOC setActualAddressCountryCodePP(String actualAddressCountryCodePP) {
	...
	public FES_1FM_DOC setActualAddressSubjectCodePP(String actualAddressSubjectCodePP) {
	...
	public FES_1FM_DOC setActualAddressAreaPP(String actualAddressAreaPP) {
	...
	public FES_1FM_DOC setActualAddressCityPP(String actualAddressCityPP) {
	...
	public FES_1FM_DOC setActualAddressStreetPP(String actualAddressStreetPP) {
	...
	public FES_1FM_DOC setActualAddressHousePP(String actualAddressHousePP) {
	...
	public FES_1FM_DOC setActualAddressCorpPP(String actualAddressCorpPP) {
	...
	public FES_1FM_DOC setActualAddressApartmentPP(String actualAddressApartmentPP) {
	...
	public FES_1FM_DOC setActualAddressIPPP(String actualAddressIPPP) {
	...
	public FES_1FM_DOC setOkvedPP(String okvedPP) {
	...
	public FES_1FM_DOC setOgrnPP(String ogrnPP) {
		this.ogrnPP = ogrnPP;
		return this;
	}
	...
	public FES_1FM_DOC setRegOrgNamePP(String regOrgNamePP) {
	...
	public FES_1FM_DOC setRegDatePP(String regDatePP) {
	...
	public FES_1FM_DOC setBik(String bik) {
		this.bik = bik;
		return this;
	}
	...
	public FES_1FM_DOC setBankAccountNumber(String bankAccountNumber) {
	...
	public FES_1FM_DOC setBankName(String bankName) {
