...
public class FES_1FM_Helper extends DriverBasedHelper {
	
	public FES_1FM_Helper(ApplicationManager manager) {
	...
	public void inputRequiredValues1FM(FES_1FM_DOC fes) throws InterruptedException {
		pages.fes_nko_Page.ensurePageLoaded()
			.setCorrespondentID(fes.getCorrespondentID())	
			.selectTypeInfo(fes.getTypeInfo())
			.setDateOfFES(fes.getDateOfFES())
